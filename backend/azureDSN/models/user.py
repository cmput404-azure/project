...
class User(models.Model):
    ...
    host = models.URLField() # The full API URL for the author's node (e.g. http://nodeaaaa/api/)
    display_name = models.CharField(max_length=20)
    github = models.URLField() # e.g. "http://github.com/gjohnson"
    page = models.URLField() # e.g. "http://nodebbbb/authors/222"
