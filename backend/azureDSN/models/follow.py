...
class Follow(models.Model):
    ...
    local_follower = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name="local follower")
    remote_follower = models.URLField(null=True, blank=True)
    local_followee = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name="remote follower")
    ...
    created_at = models.DateTimeField("date followed", auto_now_add=True)
