...
class Follow(models.Model):
    ...
    local_follower = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)
    remote_follower = models.URLField(null=True, blank=True)
    local_followee = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)
